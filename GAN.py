...
img_size = 32 * 32 * 3  # CIFAR-10 image size
...
for epoch in range(num_epoch):
    for i, (images, _) in enumerate(data_loader):
        ...
        real_loss = criterion(discriminator(images.view(batch_size, -1)), real_label)
        ...
        d_performance = discriminator(images.view(batch_size, -1)).mean()
    ...
    samples = fake_images.reshape(batch_size, num_channel, 32, 32)  # Reshape for CIFAR-10

...
# 데이터 불러오기
data = pd.read_csv('/Users/mac/Desktop/ACGAN_PST/지표/FL0_2000(0)_resultss.csv')
new_data = pd.read_csv('/Users/mac/Desktop/ACGAN_PST/지표/FL0_2000_300_1600_(0-1-2)0.3_0.5_resultss.csv')
...
plt.plot(new_data['Epoch'], new_data['Average D Accuracy'], label='PST D Accuracy', color='darkblue', linestyle='solid', linewidth=2)
